// src/screens/OrderListAdminScreen.jsx
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 p-8">
      <div className="container mx-auto bg-white rounded-xl shadow-2xl p-8">
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-8">Manage Orders (Admin)</h2>
        <p className="text-center text-xl text-gray-700 mb-8">
          This is where you'll view and update customer orders. (Functionality to be built)
        </p>
